...
Der lokale Dev-Server läuft bewusst ohne `basePath` unter `/`. Der GitHub-Pages-Build setzt `GITHUB_PAGES=true` und exportiert die App unter `/fahrschule-wollenweber-premium-site/`.
