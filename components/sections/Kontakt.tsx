...
export default function Kontakt() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // mailto-Fallback (GitHub-Pages-kompatibel)
    ...
    const mailto = `mailto:info@fahrschule-wollenweber.de?subject=${encodeURIComponent(
      betreff
    )}&body=${encodeURIComponent(body)}`;

    setStatus('success');
    setStatusMessage(
      'Vielen Dank! Wir öffnen jetzt dein Mail-Programm mit der vorausgefüllten Anfrage. Wir melden uns innerhalb von 24 Stunden.'
    );
  ...
  return (
    <section id="kontakt" className="section relative bg-gradient-to-b from-navy-deep via-navy-deep to-[#0d0d1a]">
      <div className="container-page">
        ...
        >
          <div>
            <div className="eyebrow mb-4">Schritt 1 · Termin wählen</div>
            <MonatsKalender value={datum} onChange={setDatum} />
          </div>

          <form onSubmit={handleSubmit} className="kontakt-form" noValidate>
            <div className="eyebrow mb-4">Schritt 2 · Daten eingeben</div>
            ...
            <div className="form-field">
              ...
              <textarea
                ...
                name="nachricht"
                rows={3}
                placeholder="Fragen, Wünsche oder Anmerkungen …"
              />
            </div>
      ...
      <style jsx>{`
        ...
        .form-field textarea::placeholder { color: rgba(248, 248, 251, 0.35); }
